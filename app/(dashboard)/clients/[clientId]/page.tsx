...
// ClientActions sera un composant client pour le dropdown menu (edit/delete)
// car on ne peut pas mettre d'event handlers dans un server component
...
export default async function ClientPage({ params }: PageProps) {
    try {
        ...
        // Les projets ne sont plus affichés car Client = Projet
